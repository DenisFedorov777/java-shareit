...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllBookings(Long ownerId, BookingState state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getBooking(Long ownerId, Long bookingId) {
        return get("/" + bookingId, ownerId);
    }

    public ResponseEntity<Object> postBooking(BookingDto bookingDto, Long ownerId) {
        return post("", ownerId, bookingDto);
    }
